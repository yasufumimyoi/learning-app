...
export const OtherProgress = () => {
  ...
  const chart = () => {
    ...
    const temp2 = otherVideos.filter((video: VideoProps) => video.category === 'docker')
    const temp3 = otherVideos.filter((video: VideoProps) => video.category === 'firebase')
    const temp4 = otherVideos.filter((video: VideoProps) => video.category === 'javascript')
    const temp5 = otherVideos.filter((video: VideoProps) => video.category === 'node')
    const temp6 = otherVideos.filter((video: VideoProps) => video.category === 'react')
    const temp7 = otherVideos.filter((video: VideoProps) => video.category === 'router')
    const temp8 = otherVideos.filter((video: VideoProps) => video.category === 'typescript')
    const temp9 = otherVideos.filter((video: VideoProps) => video.category === 'material')
